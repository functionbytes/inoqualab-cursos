  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-8">
      ...
      <form id="formUsers" enctype="multipart/form-data" role="form" onSubmit="return false"
            data-store-url="{{ route('support.distributors.staffs.store') }}"
            data-redirect-url-template="{{ route('support.distributors.staffs', ':slack') }}">
...
@push('scripts')
    <script src="{{ asset('supports/js/views/distributors/staffs/create.js') }}"></script>
@endpush
