...
@section('content')
    ...
    <div class="widget-content searchable-container list"
        ...
        <div class="card">
                    ...
                    <div class="col-6 col-md">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                ...
                                <span class="text-muted">Empleados asignados</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                ...
                                <span class="text-muted">Con acceso habilitado</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
            ...
            {{-- Search + Filtros --}}
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('support.distributors.staffs', $distributor->slack) }}" id="searchForm">
            ...
            <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-nowrap mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="staffs-col-checkbox"><input type="checkbox" class="form-check-input" id="select-all"></th>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('support.distributors.staffs.view', $user->slack) }}">
                                                            Visualizar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('support.distributors.staffs.edit', $user->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item confirm-delete" href="#"
                                                           data-href="{{ route('support.distributors.staffs.destroy', $user->slack) }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        @if(($searchKey ?? '') || ($available ?? '') !== '')
                            <a href="{{ route('support.distributors.staffs', $distributor->slack) }}" class="btn btn-outline-secondary">
                                Ver todos
                            </a>
                        @else
                            <a href="{{ route('support.distributors.staffs.create', $distributor->slack) }}" class="btn btn-primary">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    ...
                    <a href="{{ route('support.distributors.staffs', $distributor->slack) }}" class="btn btn-secondary w-100">
                        Limpiar filtros
                    </a>
                </div>
            </div>
