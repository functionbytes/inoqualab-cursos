    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            <form id="formInscriptions" enctype="multipart/form-data" role="form" onSubmit="return false"
                  data-enroll-url="{{ route('support.distributors.inscriptions.massives.enroll') }}"
                  data-get-users-url="{{ route('support.distributors.inscriptions.massives.get.users') }}"
                  data-get-courses-url="{{ route('support.distributors.inscriptions.massives.get.courses') }}"
                  data-store-url="{{ route('support.distributors.inscriptions.massives.store') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        ...
                        <p class="text-muted small mb-0">
                            Matricula a varios usuarios de una empresa en varios cursos a la vez.
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">
                        Si algún usuario ya está inscrito en alguno de los cursos seleccionados, el sistema
                        lo avisará y te dará la opción de inscribirlo nuevamente.
                    </p>
                </div>
            </div>
        </div>
...
@push('scripts')
    <script src="{{ asset('supports/js/views/distributors/inscriptions/massives/index.js') }}"></script>
@endpush
