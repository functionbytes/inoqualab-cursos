...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Reporte de ordenes'])
@endsection
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        ...
                        <p class="text-muted small mb-0">
                            Genera el reporte de órdenes de este distribuidor filtrando por empresa
                            y rango de fechas.
                        </p>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">
                        El reporte se descarga en formato Excel (.xlsx) con las órdenes del rango
                        de fechas seleccionado. Deja "Todas" en empresas para incluir todas las
                        empresas de este distribuidor.
                    </p>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{ asset('supports/js/views/distributors/orders/report/report.js') }}"></script>
@endpush
