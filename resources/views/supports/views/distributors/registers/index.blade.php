...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Registro'])
@endsection
@section('content')
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            <form id="formRegisters" enctype="multipart/form-data" role="form" onSubmit="return false"
                  data-check-url="{{ route('support.distributors.registers.users.check') }}"
                  data-store-url="{{ route('support.distributors.registers.store') }}"
                  data-users-url-template="{{ route('support.enterprises.users', ':slack') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        <h6 class="mb-1 fw-bold">Registro de usuario</h6>
                        <p class="text-muted small mb-0">
                            Registra un nuevo usuario para una empresa de este distribuidor. Selecciona
                            la empresa y completa los datos del usuario para crear su cuenta.
                        </p>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">
                        El usuario queda vinculado a la empresa seleccionada. Si la identificación
                        ya existe, el sistema te permitirá reasignarla o ir directamente a la empresa.
                    </p>
                </div>
            </div>
        </div>
    ...
    @push('scripts')
        <script src="{{ asset('supports/js/views/distributors/registers/index.js') }}"></script>
    @endpush
