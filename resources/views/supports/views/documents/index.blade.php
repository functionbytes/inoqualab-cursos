...
@section('content')
    ...
    <div class="widget-content searchable-container list" id="documents-list"
         data-bulk-url="{{ route('support.documents.bulk-action') }}">
        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="mb-0 text-muted">Gestiona los documentos y archivos del portal</p>
                    </div>
                    <div class="ms-auto">
                    ...
                    <div class="col-6 col-md">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                ...
                                <span class="text-muted">Documentos configurados</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                <h6 class="card-title mb-2">Públicos</h6>
            ...
            {{-- Search + Filtros --}}
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('support.documents') }}" id="searchForm">
            ...
            <div class="card-body">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('support.documents.edit', $document->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item confirm-delete" href="#"
                                                           data-href="{{ route('support.documents.destroy', $document->slack) }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                @else
                    <div class="text-center py-5">
                        <i class="fas fa-file-lines fa-3x mb-3 text-muted opacity-50"></i>
                        ...
                        <p class="text-muted mb-4">
                            ...
                            @else
                                Crea el primer documento del portal.
                            @endif
                        </p>
                        @if($searchKey || ($available ?? '') !== '')
                            <a href="{{ route('support.documents') }}" class="btn btn-outline-secondary">
                                Ver todos
                            </a>
                        @else
                            <a href="{{ route('support.documents.create') }}" class="btn btn-primary">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    ...
                    <a href="{{ route('support.documents') }}" class="btn btn-secondary w-100">
                        Limpiar filtros
                    </a>
                </div>
            </div>
