                                ...
                                <div class="card-body text-center">
                                    @if ($topic->quiz_again >= 1)
                                        @if ($score >= 80)
                                            ...
                                            <div class="mt-5">
                                                <a class="btn btn-light-primary text-primary  w-100 mt-3" href="{{ route('customers.certificate.download', $certificate->slack) }}">Certificado</a>
                                                <a class="btn btn-light-primary text-primary  w-100 mt-3" href="{{ route('customers.dashboard') }}">Volver</a>
                                            </div>
                                        ...
                                        @elseif($score < 80)
                                            ...
                                            <div class="mt-5">
                                                <a class="btn btn-light-primary text-primary  w-100 mt-3" href="{{ route('customers.exam.tryagain', $exam->id) }}">Reintentar</a>
                                            </div>
