                                ...
                                <div class="card-body text-center">
                                    ...
                                    @if ($topic->quiz_again >= 1)
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <form action="{{ route('customers.quiz.realized') }}" method="POST">
                                                    ...
                                                    <button type="submit" class="btn btn-light-primary text-primary w-100 mt-3"
                                                        href="{{ route('customers.quiz.tryagain', $quiz->id) }}">Siguente</button>
                                        ...
                                        @elseif($quiz->score < 80)
                                            ...
                                            <div class="mt-5">
                                            <a class="btn btn-light-primary text-primary w-100  mt-3" href="{{ route('customers.quiz.tryagain', $quiz->id) }}">Reintentar</a>
                                            </div>
                                        @endif
                                    @endif
