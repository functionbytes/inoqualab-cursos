...
@push('css')
    <link rel="stylesheet" href="{{ asset('supports/css/views/users/quizs/quiz.css') }}">
@endpush
@section('content')
    <div class="row">
        <div class="col-lg-12">
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                @foreach ($questions as $key => $question)
                                                    ...
                                                    @if ($key > 0)
                                                        ...
                                                        <div class="exam-step-hidden" id="more_quiz{{ $key }}">
                                                    ...
                                                    <div class="row text-center owl-nav">
                                                        ...
                                                        @if ($count == $que_count)
                                                            ...
                                                            <a id="finish"  class="owl">
                                                                <i class="fas fa-clipboard me-1 fs-6"></i>
                                                                Finalizar
                                                            </a>
                                                            </div>
                                                        @endif
...
@endsection
        ...
        @push('scripts')
            <script src="{{ asset('supports/js/views/users/quizs/quiz.js') }}"></script>
        @endpush