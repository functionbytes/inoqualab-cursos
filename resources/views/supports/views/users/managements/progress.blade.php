...
@section('page_header')
    @include('supports.includes.card', ['title' => "Progreso - " . $course->title ])
@endsection
                                ...
                                <table class="table align-middle text-nowrap mb-0">
                                    ...
                                    @foreach ($chapter as $key => $class)
                                        ...
                                        @php
                                            ...
                                            $return = App\Models\Course\CourseProgress::return($class->id,$inscription->id,$user->id);
                                        @endphp
...
@push('scripts')
    ...
    <script src="{{ asset('supports/js/views/users/managements/progress.js') }}"></script>
@endpush
