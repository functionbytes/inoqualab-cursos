    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div>
                    <h5 class="mb-1 fw-bold">Actividades - {{ $user->firstname.' '.$user->lastname }}</h5>
                    <p class="mb-0 text-muted">Historial de auditoría de acciones realizadas por este usuario</p>
                </div>
            </div>
                        ...
                        <div class="col-6 col-md">
                            <div class="card bg-light-secondary h-100">
                                <div class="card-body">
                                    ...
                                    <h4 class="mb-1 fw-bold">{{ number_format($stats['counts'][$key] ?? 0) }}</h4>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('support.users.activitys.view', $activity->id) }}">
                                                            Ver detalle
                                                        </a>
                                                    </li>
                                                </ul>
            ...
            @if($activities->hasPages())
                <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center">
                    <span class="text-muted">
                        Mostrando {{ $activities->firstItem() }}–{{ $activities->lastItem() }} de {{ $activities->total() }} registros
                    </span>
                    {{ $activities->links() }}
                </div>
            @endif
