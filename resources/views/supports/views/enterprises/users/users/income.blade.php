...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Reporte usuarios'])
@endsection
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            <form id="formAction" enctype="multipart/form-data" role="form"
                  data-generate-url="{{ route('support.enterprises.users.incoming') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{ Str::upper(Str::lower($enterprise->title)) }}" disabled>
                                </div>
                            </div>
                            <div class="col-12">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header border-bottom">
                    <h6 class="mb-0 fw-bold">Sobre el reporte</h6>
                </div>
                <div class="card-body">
                    <p class="text-muted mb-0">
                        Se descarga un archivo Excel con los usuarios que ingresaron al curso
                        seleccionado dentro del rango de fechas indicado.
                    </p>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{ asset('supports/js/enterprises/users/users/income.js') }}"></script>
@endpush
