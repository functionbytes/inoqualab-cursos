...
@section('page_header')
    @include('supports.includes.card', ['title' => $enterprise->title])
@endsection
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center nav-cards-grid">
                    <div class="col-sm-6 col-lg-4">
                        <a class="card nav-cards-card" href="{{ route('support.enterprises.users', $enterprise->slack) }}">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card nav-cards-card" href="{{ route('support.enterprises.staffs', $enterprise->slack) }}">
                            <div class="card-body text-center">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card nav-cards-card" href="{{ route('support.enterprises.courses', $enterprise->slack) }}">
                            <div class="card-body text-center">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card nav-cards-card" href="{{ route('support.enterprises.users.income', $enterprise->slack) }}">
                            <div class="card-body text-center">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card nav-cards-card" href="{{ route('support.enterprises.inscriptions', $enterprise->slack) }}">
                            <div class="card-body text-center">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card nav-cards-card" href="{{ route('support.enterprises.reassign', $enterprise->slack) }}">
                            <div class="card-body text-center">
...
@push('css')
<link rel="stylesheet" href="{{ asset('supports/css/views/enterprises/enterprises/navegation.css') }}">
@endpush
