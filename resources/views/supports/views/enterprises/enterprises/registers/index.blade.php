...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-stretch">
            ...
            <div class="card w-100">
                ...
                <form id="formRegisters" enctype="multipart/form-data" role="form"
                      data-check-url="{{ route('distributor.registers.users.check') }}"
                      data-store-url="{{ route('support.distributors.registers.store') }}"
                      data-users-url="{{ route('support.enterprises.users', ':slack') }}">
    ...
    @push('scripts')
        <script src="{{ asset('supports/js/enterprises/enterprises/registers/index.js') }}"></script>
    @endpush
