...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Reporte de usuarios — ' . $course->title])
@endsection
@section('content')
        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <form id="formReport" enctype="multipart/form-data" role="form"
                      data-generate-url="{{ route('support.enterprises.courses.generate') }}">
                    {{ csrf_field() }}
...
@push('scripts')
    <script src="{{ asset('supports/js/enterprises/courses/reports.js') }}"></script>
@endpush
