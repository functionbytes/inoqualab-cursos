...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Reasignar usuarios'])
@endsection
...
@section('content')
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header border-bottom">
                    <h6 class="mb-0 fw-bold">Sobre la reasignación</h6>
                </div>
                <div class="card-body">
                    <p class="text-muted mb-0">
                        Los usuarios seleccionados se moverán del curso actual al curso destino que elijas.
                    </p>
                </div>
            </div>
        </div>
