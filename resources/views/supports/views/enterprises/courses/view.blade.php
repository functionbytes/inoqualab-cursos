...
@section('page_header')
    @include('supports.includes.card', ['title' => "Usuarios - " . $course->title ])
@endsection
            ...
            <div class="card-body">
                        ...
                        <table class="table table-hover align-middle text-nowrap mb-0">
                            ...
                            <tbody>
                                @foreach ($inscriptions as $inscription)
                                    <tr>
                                        <td>
                                            <span>{{ ucfirst($inscription->identification) }}</span>
                                        </td>
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    @if($inscription->culminated == 1)
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('support.enterprises.users.certificate.user', $inscription->slack) }}">Certificado</a>
                                                        </li>
                                                    @endif
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('support.enterprises.courses.details', $inscription->slack) }}">Detalle</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('support.enterprises.courses.progress', $inscription->slack) }}">Reporte</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-0">No hay usuarios inscritos que coincidan con los filtros aplicados.</p>
                    </div>
                @endif
            </div>
...
@push('scripts')
<script src="{{ asset('supports/js/enterprises/courses/view.js') }}"></script>
@endpush
