...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Editar categoria'])
@endsection
@section('content')
  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-8">
      ...
      <form id="formCategories" enctype="multipart/form-data" role="form"
            data-update-url="{{ route('support.instructions.categories.update') }}"
...
@push('scripts')
<script src="{{ asset('supports/js/views/instructions/categories/edit.js') }}"></script>
@endpush
