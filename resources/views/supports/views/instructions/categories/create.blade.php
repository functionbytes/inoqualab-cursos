  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-8">
      ...
      <form id="formCategories" enctype="multipart/form-data" role="form"
            data-store-url="{{ route('support.instructions.categories.store') }}"
            data-redirect-url="{{ route('support.instructions.categories') }}">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="text-muted mb-3">
              Completa los datos de la categoría. Los campos marcados como obligatorios deben diligenciarse para poder guardarla.
            </p>
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-muted mb-0">Las categorías agrupan las instrucciones del centro de ayuda. El campo <strong>Icono</strong> identifica visualmente la categoría en el listado.</p>
        </div>
      </div>
...
@push('scripts')
<script src="{{ asset('supports/js/views/instructions/categories/create.js') }}"></script>
@endpush
