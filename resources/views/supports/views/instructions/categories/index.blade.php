...
@section('content')
    ...
    <div class="widget-content searchable-container list" id="instructions-categories-list"
        ...
        <div class="card">
            ...
            {{-- Search + Filtros --}}
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('support.instructions.categories') }}" id="searchForm">
            ...
            <div class="card-body">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('support.instructions.categories.edit', $categorie->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item confirm-delete" href="#"
                                                           data-href="{{ route('support.instructions.categories.destroy', $categorie->slack) }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                @else
                    <div class="text-center py-5">
                        <i class="fas fa-folder fa-3x mb-3 text-muted opacity-50"></i>
                        ...
                        <p class="text-muted mb-4">
                            ...
                            @else
                                Crea la primera categoría de instrucciones.
                            @endif
                        </p>
                        @if($searchKey || ($available ?? '') !== '')
                            <a href="{{ route('support.instructions.categories') }}" class="btn btn-outline-secondary">
                                Ver todas
                            </a>
                        @else
                            <a href="{{ route('support.instructions.categories.create') }}" class="btn btn-primary">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    ...
                    <a href="{{ route('support.instructions.categories') }}" class="btn btn-secondary w-100">
                        Limpiar filtros
                    </a>
                </div>
            </div>
