...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Crear instrucciones'])
@endsection
@section('content')
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            ...
            <form id="formInstructions" enctype="multipart/form-data" role="form"
                  data-store-url="{{ route('support.instructions.store') }}"
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        <h6 class="mb-1 fw-bold">Crear instrucciones</h6>
                        <p class="text-muted small mb-0">
                            Completa los datos de la instrucción. Los campos marcados como obligatorios deben diligenciarse para poder guardarla.
                        </p>
                    </div>
...
@push('scripts')
<script src="{{ asset('supports/js/views/instructions/instructions/create.js') }}"></script>
@endpush
