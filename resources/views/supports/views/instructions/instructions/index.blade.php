        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1 fw-bold">Instrucciones</h5>
                        <p class="mb-0 text-muted">Gestiona las instrucciones de ayuda del portal</p>
                    </div>
                    <div class="ms-auto">
                    ...
                    <div class="col-6 col-md">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                ...
                                <span class="text-muted">Instrucciones configuradas</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md">
            ...
            {{-- Search + Filtros --}}
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('support.instructions') }}" id="searchForm">
                            ...
                            <tbody>
                                @foreach($instructions as $instruction)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fw-semibold">{{ Str::words($instruction->title, 8, '...') }}</div>
                                        </td>
                                        <td>
                                            <span class="text-muted">{{ $instruction->categorie->title ?? '—' }}</span>
                                        </td>
                                        <td class="text-center">
                                            @if($instruction->available == 1)
                                        ...
                                        <td class="text-center">
                                            <span class="text-muted">{{ $instruction->updated_at->format('d/m/Y') }}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('support.instructions.edit', $instruction->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item confirm-delete" href="#"
                                                           data-href="{{ route('support.instructions.destroy', $instruction->slack) }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-4">
                            @if($searchKey || ($available ?? '') !== '')
                                No hay instrucciones que coincidan con los filtros aplicados.
                            @else
                                Crea la primera instrucción del portal.
                            @endif
                        </p>
                        @if($searchKey || ($available ?? '') !== '')
                            <a href="{{ route('support.instructions') }}" class="btn btn-outline-secondary">
                                Ver todas
                            </a>
                        @else
                            <a href="{{ route('support.instructions.create') }}" class="btn btn-primary">
            ...
            @if($instructions->hasPages())
                <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center">
                    <span class="text-muted">
                        Mostrando {{ $instructions->firstItem() }}–{{ $instructions->lastItem() }} de {{ $instructions->total() }} instrucciones
                    </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    ...
                    <a href="{{ route('support.instructions') }}" class="btn btn-secondary w-100">
                        Limpiar filtros
                    </a>
                </div>
            </div>
