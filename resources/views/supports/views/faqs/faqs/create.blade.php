...
@section('page_header')
    @include('supports.includes.card', ['title' => 'Crear pregunta frecuente'])
@endsection
@section('content')
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            ...
            <form id="formFaqs" enctype="multipart/form-data" role="form"
                  data-store-url="{{ route('support.faqs.store') }}"
...
@push('scripts')
<script src="{{ asset('supports/js/views/faqs/faqs/create.js') }}"></script>
@endpush
