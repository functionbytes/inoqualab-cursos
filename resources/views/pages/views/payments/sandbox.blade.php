            ...
            <div class="cartx-grid" style="grid-template-columns:1fr 390px;">
                ...
                <div class="cartx-reveal">
                    <div class="cart-page-card">
                        ...
                        <div class="sandbox" style="margin-top:22px;">
                            ...
                            <div class="sandbox-body" style="display:block;">
                ...
                <div class="cartx-summary-col cartx-reveal">
                    <div class="summary">
                        ...
                        <div class="summary-body">
                            <p class="cp-sub" style="margin-bottom:18px;">Simula el resultado del pago para continuar:</p>

                            <a class="go-pay" href="{{ route('checkout.simulate', [$order->slack, 'APPROVED']) }}" style="background:#1f9d57;box-shadow:0 10px 24px rgba(31,157,87,.28);">
                                <i class="fas fa-check"></i> Simular pago aprobado
                            </a>
                            <a class="go-pay" href="{{ route('checkout.simulate', [$order->slack, 'PENDING']) }}" style="margin-top:11px;background:#0d1b2a;">
                                <i class="fas fa-clock"></i> Simular pendiente
                            </a>
                            <a class="go-pay" href="{{ route('checkout.simulate', [$order->slack, 'DECLINED']) }}" style="margin-top:11px;background:#d24a43;box-shadow:0 10px 24px rgba(210,74,67,.26);">
