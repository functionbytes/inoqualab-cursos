    ...
    <div class="row">
        <div class="progress-wrapper mb-5 col-md-6 d-block mx-auto">
            <div class="progress progress-md">
                <div class="progress-bar-striped progress-bar-animated bg-success progress-bar--60" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
        </div>
    </div>
</div>
...
@push('css')
    <link rel="stylesheet" href="{{ asset('pages/css/views/maintenance.css') }}">
@endpush
