...
<head>
    ...
    <link rel="stylesheet" href="{{ url('enterprises/css/style.css') }}">
...
<div class="page-wrapper" id="main-wrapper" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed"
    ...
    @include ('accountings.includes.nav')
    ...
    <div class="body-wrapper">
        ...
        @include ('accountings.includes.header')

        <div class="container-fluid">
            @yield('content')
        </div>

        @include('accountings.includes.delete')
