...
<head>
    ...
    <link rel="stylesheet" href="{{ url('distributors/css/style.css') }}">
...
data-header-position="fixed" data-layout="horizontal">
    ...
    @include ('distributors.includes.nav')

    <!-- Main wrapper -->

    <div class="body-wrapper">

        @include ('distributors.includes.header')

        <div class="container-fluid">
            @yield('content')
        </div>

        @include ('distributors.includes.support')

        @include('distributors.includes.delete')
    </div>
</div>
