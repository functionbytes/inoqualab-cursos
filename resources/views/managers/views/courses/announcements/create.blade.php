    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-stretch">
            ...
            <div class="card w-100">
                ...
                <form id="formAnnouncements" enctype="multipart/form-data" role="form" onSubmit="return false">
                    ...
                    <div class="card-body border-top">
                        <div class="d-flex no-block align-items-center">
                            <h5 class="mb-0">Crear anuncio</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="border-top pt-1 mt-4">
                                    ...
                                    <a href="{{ route('manager.courses.announcements', $course->slack) }}" class="btn btn-light px-4 waves-effect mt-2 w-100 text-center">
                                        Cancelar
                                    </a>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $("#formAnnouncements").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('manager.courses.announcements.store') }}",
                        headers: {
                        ...
                        success: function(response) {
                            ...
                            if(response.success == true){
                                ...
                                setTimeout(function() {
                                    ...
                                    location.href = "{{route('manager.courses.announcements', $course->slack)}}";
                                }, 2000);
