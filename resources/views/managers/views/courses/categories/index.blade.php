                  ...
                  <td class="text-left">
                    <div class="dropdown dropstart">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                          <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.categories.courses.edit', $categorie->slack) }}">Editar</a>
                        </li>
                        <li>
                          <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete" data-href="{{ route('manager.categories.courses.destroy', $categorie->slack) }}">Eliminar</a>
                        </li>
                      </ul>
                    </div>
                  </td>
