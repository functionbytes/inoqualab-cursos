...
@section('content')
                ...
                <div id="rootwizard" class="m-t-50">
                    <div class="tab-content">
                        ...
                        <div class="pane padding-20 sm-no-padding">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('enterprise.dashboard') }}">Dashboard</a></li>
    ...
    @include ('managers.partials.sections.enterprises.wrapper')

@endsection

@push('scripts')
<script src="{{ asset('managers/js/views/users/users/postpone.js') }}"></script>
@endpush
