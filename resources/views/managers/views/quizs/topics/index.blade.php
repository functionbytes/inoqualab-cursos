                            ...
                            <td class="text-left">{{----}}
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdown-{{ $question->slack }}">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.courses.quiz.questions.edit', $question->slack) }}">Editar</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete" data-href="{{ route('manager.courses.quiz.questions.destroy', $question->slack) }}">Eliminar</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
