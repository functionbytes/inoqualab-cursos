        ...
        <div class="card">
            <form action="{{ route('mailers.variables.store') }}" method="POST">
                ...
                <div class="card-header border-bottom">
                    ...
                    <p class="text-muted small mb-0">Define la clave, categoría y descripción de la variable.</p>
                </div>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary w-100">Crear variable</button>
                </div>
            </form>
        </div>
    </div>
