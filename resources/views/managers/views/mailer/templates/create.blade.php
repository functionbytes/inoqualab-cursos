                ...
                <div class="card">
                    ...
                    <div class="tab-content" id="editorTabsContent">
                        ...
                        <div class="tab-pane fade p-3" id="preview-panel" role="tabpanel" aria-labelledby="preview-tab">
                            ...
                            <div id="previewContainerTab" style="min-height: 500px; max-height: 700px; overflow-y: auto; background: #f8f9fa; border-radius: 4px; display: flex; justify-content: center; padding: 20px;">
