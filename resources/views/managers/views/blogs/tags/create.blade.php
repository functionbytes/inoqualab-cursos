...
@section('page_header')
    @include('managers.includes.card', ['title' => 'Crear etiqueta'])
@endsection
@section('content')
  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-8">
      ...
      <div id="blogs-tags-create"
        ...
        <form id="formTags" enctype="multipart/form-data" role="form">
          ...
          <div class="card-body">
            <h6 class="fw-bold text-dark mb-1">Crear etiqueta</h6>
            <p class="text-muted mb-3">
              Completa los datos de la etiqueta. Los campos marcados como obligatorios deben diligenciarse para poder guardarla.
            </p>
            <div class="row g-3">
              <div class="col-6">
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-muted mb-0">Se usan para clasificar las noticias del blog y permitir filtrarlas por tema.</p>
        </div>
      </div>
