          ...
          <tbody>
              @foreach ($categories as $key => $categorie)
                <tr class="search-items">
                  <td>
                    <span class="usr-email-addr" data-email="{{ $categorie->title }}">{{ $categorie->title }}</span>
                  </td>
                  <td>
                  ...
                  <td class="text-left">
                    <div class="dropdown dropstart">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                          <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.blogs.categories.edit', $categorie->slack) }}">Editar</a>
                        </li>
                        <li>
                          <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete" data-href="{{ route('manager.blogs.categories.destroy', $categorie->slack) }}">Eliminar</a>
                        </li>
                      </ul>
                    </div>
                  </td>
