...
@section('title', 'Resumen de órdenes')

@section('page_header')
    @include('managers.includes.card', ['title' => 'Resumen de órdenes'])
@endsection
                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ Request::fullUrl() }}" method="GET">
                        ...
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('manager.orders.report') }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reporte">
                                    <i class="fa-solid fa-file-chart-column"></i>
                                </a>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('manager.orders.resumen') }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Resumen">
                                    <i class="fa-solid fa-file-chart-column"></i>
                                </a>
                            </div>
                        </div>
