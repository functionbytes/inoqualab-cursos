...
@section('page_header')
    @include('managers.includes.card', ['title' => 'Reporte ordenes'])
@endsection
@section('content')
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            ...
            <div id="orders-report-index"
                ...
                <form id="formReport" enctype="multipart/form-data" role="form">
                    ...
                    <div class="card-body">
                        <h6 class="fw-bold text-dark mb-1">Reporte ordenes</h6>
                        <p class="text-muted mb-3">
                            Selecciona el distribuidor, la empresa, la condición, el método de pago y el rango de fechas para generar el reporte de órdenes.
                        </p>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">Deja un filtro sin seleccionar para incluir todas sus opciones en el reporte. Si eliges un distribuidor, la lista de empresas se filtra automáticamente a las suyas.</p>
                </div>
            </div>
