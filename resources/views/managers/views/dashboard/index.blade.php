...
@section('content')
    @php
        $dashboardConfig = [
            'profitSeries' => $numberEanings,
            'profitCategories' => $monthEanings,
            'ordersSeries' => $viewOrders,
        ];
    @endphp
    <div class="container-fluid" id="dashboard-index"
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <h4 class="fw-semibold mb-2">{{ $courses }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <h4 class="fw-semibold mb-2">{{ $enterprises }}</h4>
                            </div>
                            <div class="col-4 d-flex justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <h4 class="fw-semibold mb-2">{{ $blogs }}</h4>
                            </div>
                            <div class="col-4 d-flex justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <h4 class="fw-semibold mb-2">{{ $usercustomers }}</h4>
                            </div>
                            <div class="col-4 d-flex justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-8">
                                ...
                                <h4 class="fw-semibold mb-2">{{ $useradmins }}</h4>
                            </div>
                            <div class="col-4 d-flex justify-content-center">
