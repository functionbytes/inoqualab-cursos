...
@section('page_header')
    @include('managers.includes.card', ['title' => $__pageTitle])
@endsection
@section('content')
  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        <div class="card-header border-bottom">
          <h6 class="mb-0 fw-bold">Sobre los usuarios de empresa</h6>
        </div>
        <div class="card-body">
          <p class="text-muted mb-0">Solo los usuarios con estado <strong>activo</strong> pueden acceder a los cursos asignados por la empresa.</p>
        </div>
      </div>
