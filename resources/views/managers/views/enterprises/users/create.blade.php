...
@section('page_header')
    @include('managers.includes.card', ['title' => 'Crear usuario'])
@endsection
@section('content')
  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-muted mb-0">Después de crear el usuario podrás asignarlo a los cursos disponibles para esta empresa.</p>
        </div>
      </div>
