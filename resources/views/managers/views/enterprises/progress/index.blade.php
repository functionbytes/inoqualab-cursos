        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="row align-items-center">
                    ...
                    <h4 class="fw-semibold mb-3">{{ $progres }}%</h4>
                        ...
                        <table class="table align-middle text-nowrap mb-0">
                            ...
                            @foreach ($chapter as $class)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $validate  ? 'bg-light-primary' : 'bg-light-secondary' }} rounded-3 py-2 text-primary fw-semibold fs-2 d-inline-flex align-items-center gap-1">
...
@push('scripts')
<script src="{{ url('managers/libs/owl.carousel/dist/owl.carousel.min.js') }}"></script>
<script src="{{ url('managers/libs/apexcharts/dist/apexcharts.min.js') }}"></script>
<script src="{{ asset('managers/js/views/enterprises/progress/index.js') }}"></script>
@endpush