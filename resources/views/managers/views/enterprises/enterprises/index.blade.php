...
@section('content')
  ...
  @include('managers.includes.card', ['title' => 'Empresas'])
        ...
        <table class="table search-table align-middle text-nowrap">
          ...
          @foreach ($enterprises as $key => $enterprise)
            <tr class="search-items">
              ...
              <td>
                <span class="usr-email-addr" data-email="{{ Str::lower($enterprise->title)  }}">{{ Str::words( Str::upper(Str::lower($enterprise->title)), 4, '...')  }}</span>
              </td>
              ...
              <td class="text-left">
                <div class="dropdown dropstart">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.navegation', $enterprise->slack) }}">Dashboard</a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.edit', $enterprise->slack) }}">Editar</a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3 confirm-delete" data-href="{{ route('manager.enterprises.destroy', $enterprise->slack) }}">Eliminar</a>
                    </li>
                  </ul>
                </div>
              </td>
