...
@section('page_header')
    @include('managers.includes.card', ['title' => 'Editar empresa'])
@endsection
@section('content')
  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-8">
      ...
      <form id="formEnterprises" enctype="multipart/form-data" role="form"
            data-update-url="{{ route('manager.enterprises.update') }}"
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-muted mb-0">Solo las empresas con estado <strong>activo</strong> pueden inscribir nuevos usuarios.</p>
        </div>
      </div>
...
@push('scripts')
<script src="{{ asset('managers/js/views/enterprises/enterprises/edit.js') }}"></script>
@endpush
