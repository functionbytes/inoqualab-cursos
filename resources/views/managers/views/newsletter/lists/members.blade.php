        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    <button type="button" id="btnAddMember" class="btn btn-primary w-100 mb-2">Agregar</button>
...
$(function () {
    ...
    $('#btnAddMember').on('click', function () {
        ...
        if (! email) { toastr.warning('El email es obligatorio.'); return; }

        var $btn = $(this).prop('disabled', true);
        $.ajax({
            url: '{{ route('manager.newsletter.lists.members.add', $list->id) }}',
            method: 'POST',
    ...
    $(document).on('click', '.btn-remove-member', function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                toastr.success(res.message || 'Suscriptor retirado.');
