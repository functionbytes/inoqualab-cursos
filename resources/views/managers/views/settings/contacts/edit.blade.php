...
@section('page_header')
    @include('managers.includes.card', ['title' => 'Editar contáctenos'])
@endsection
@section('content')
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <h6 class="mb-0 fw-bold">Sobre este formulario</h6>
                </div>
                <div class="card-body">
                    <p class="text-muted mb-0">Los datos del contacto los ingresó la persona en el sitio público y no se pueden modificar aquí. Solo el <strong>estado de revisión</strong> es editable.</p>
                </div>
            </div>
