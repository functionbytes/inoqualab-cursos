            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="mb-0 text-muted">Gestiona las instrucciones y su visibilidad</p>
                    </div>
                    <div class="ms-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-nowrap mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="instructions-col-checkbox">
                            ...
                            <tbody>
                                @foreach($instructions as $instruction)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fw-semibold">{{ $instruction->title }}</div>
                                        </td>
                                        <td>
                                            <span class="text-muted">{{ $instruction->categorie?->title ?? 'Sin categoría' }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    @can('instructions.update')
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('manager.instructions.edit', $instruction->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    @endcan
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item btn-delete" href="#"
                                                           data-url="{{ route('manager.instructions.destroy', $instruction->slack) }}"
                                                           data-title="Eliminar: {{ $instruction->title }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                    @endcan
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-4">
                            ...
                            @else
                                Crea la primera instrucción de la plataforma.
                            @endif
                        </p>
                        @if(($searchKey ?? '') !== '' || ($available ?? '') !== '')
