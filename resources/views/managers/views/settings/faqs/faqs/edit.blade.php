...
@section('page_header')
    @include('managers.includes.card', ['title' => 'Editar pregunta frecuente'])
@endsection
@section('content')
        ...
        <div class="col-lg-8">
            ...
            <form id="formFaqs" enctype="multipart/form-data" role="form"
                  data-urls='@php $__jsonInline1 = [
                      "update" => route("manager.faqs.update"),
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        <h6 class="mb-1 fw-bold">Editar pregunta frecuente</h6>
...
@push('scripts')
<script src="{{ asset('managers/js/views/settings/faqs/faqs/edit.js') }}"></script>
@endpush
