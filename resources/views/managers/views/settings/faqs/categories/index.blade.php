...
@section('content')
    ...
    <div id="faqCategoriesPage" class="widget-content searchable-container list"
         data-flash-success="{{ session('success') }}"
         data-flash-error="{{ session('error') }}"
         data-bulk-action-url="{{ route('manager.faqs.categories.bulk-action') }}">
        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1 fw-bold">Categorias de preguntas frecuentes</h5>
                        <p class="mb-0 text-muted">Gestiona las categorias para organizar las FAQ</p>
                    </div>
                    <div class="ms-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-nowrap">
                            <thead class="table-light">
                                <tr>
                                    <th class="faqs-categories-col-checkbox">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('manager.faqs.categories.edit', $categorie->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item btn-delete" href="#"
                                                           data-url="{{ route('manager.faqs.categories.destroy', $categorie->slack) }}"
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-4">
                            ...
                            @else
                                Crea la primera categoria para organizar las preguntas frecuentes.
                            @endif
                        </p>
                        @if(($searchKey ?? '') !== '' || ($available ?? '') !== '')
                            <a href="{{ route('manager.faqs.categories') }}" class="btn btn-outline-secondary">
                                Ver todas
                            </a>
                        @else
                            <a href="{{ route('manager.faqs.categories.create') }}" class="btn btn-primary">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    ...
                    <a href="{{ route('manager.faqs.categories') }}" class="btn btn-secondary w-100">
                        Limpiar filtros
                    </a>
                </div>
            </div>
...
@push('css')
<link rel="stylesheet" href="{{ asset('managers/css/views/settings/faqs/categories/index.css') }}">
@endpush

@push('scripts')
<script src="{{ asset('managers/js/views/settings/faqs/categories/index.js') }}"></script>
@endpush
