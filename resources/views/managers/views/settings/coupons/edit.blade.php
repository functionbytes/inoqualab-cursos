...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var selectedCourses = @json($coupon_courses);
            var selectedBundles = @json($coupon_bundles);
            ...
            if (selectedBundles.length > 0) {
                $('#bundles').val(selectedBundles).trigger('change');
            }
            ...
            $("#formCoupons").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        url: "{{ route('manager.coupons.update') }}",
                        headers: {
