            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="mb-0 text-muted">Gestiona los certificados disponibles en la plataforma</p>
                    </div>
                    <div class="ms-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-nowrap mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="certifications-col-checkbox">
                            ...
                            <tbody>
                                @foreach($certifications as $certification)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="text-muted">{{ date('d/m/Y', strtotime($certification->updated_at)) }}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    @if($certification->getFirstMedia('thumbnail'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                               href="{{ $certification->getFirstMedia('thumbnail')->getFullUrl() }}"
                                                               target="_blank">
                                                                Visualizar
                                                            </a>
                                                        </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('manager.certifications.edit', $certification->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li>
                                                        <a class="dropdown-item btn-delete" href="#"
                                                           data-url="{{ route('manager.certifications.destroy', $certification->slack) }}"
                                                           data-title="Eliminar: {{ $certification->title }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-4">
                            ...
                            @else
                                Crea el primer certificado de la plataforma.
                            @endif
                        </p>
                        @if(($searchKey ?? '') !== '' || ($available ?? '') !== '')
                            <a href="{{ route('manager.certifications') }}" class="btn btn-outline-secondary">
                                Ver todos
                            </a>
                        @else
                            <a href="{{ route('manager.certifications.create') }}" class="btn btn-primary">
            ...
            @if($certifications->hasPages())
                <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center">
                    <span class="text-muted">
                        Mostrando {{ $certifications->firstItem() }}–{{ $certifications->lastItem() }} de {{ $certifications->total() }} certificados
                    </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    ...
                    <a href="{{ route('manager.certifications') }}" class="btn btn-secondary w-100">
                        Limpiar filtros
                    </a>
                </div>
            </div>
