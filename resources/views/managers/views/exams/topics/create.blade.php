        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            ...
            <div class="card w-100">
                ...
                <form id="formQuestions" enctype="multipart/form-data" role="form" onSubmit="return false">
                    ...
                    <input type="hidden" id="topic" name="topic" value="{{ $topic->slack }}"/>

                    <div class="card-body border-top">
                        <div class="d-flex no-block align-items-center">
                            <h5 class="mb-0">Crear pregunta</h5>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="question"  name="question" value="" placeholder="Ingresar la pregunta">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        @if ($topic->type == '1')
                                            {!! Form::select('answer[]', $answers, null, ['class' => 'select2 f§orm-control','id' => 'answer', 'multiple' => 'multiple']) !!}
                                        @else
                                            {!! Form::select('answer', $answers, null , ['class' => 'select2 form-control','id' => 'answer']) !!}
                                        @endif
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="a"  name="a" value="" placeholder="Ingresar la respuesta a">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="b"  name="b" value="" placeholder="Ingresar la respuesta b">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="c"  name="c" value="" placeholder="Ingresar la respuesta c">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="d"  name="d" value="" placeholder="Ingresar la respuesta d">
                                        </div>
                                    </div>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $("#formQuestions").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('manager.courses.exam.questions.store') }}",
                        headers: {
                        ...
                        success: function(response) {
                            ...
                            if(response.success == true){
                                ...
                                setTimeout(function() {
                                    location.href = "{{route('manager.courses.exam.questions', $topic->slack)}}";
                                }, 2000);
