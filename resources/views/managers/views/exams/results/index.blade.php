...
@section('content')
    ...
    @include('managers.includes.card', ['title' => 'Resultado examenes'])
                            ...
                            <div class="col-auto">
                                <div class="input-group">
                                    <select class="form-select select2" name="course" data-minimum-results-for-search="Infinity">
                                        <option value="">Seleccionar cur</option>
                            ...
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.results.view', $certificate->slack) }}">Visualizar</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.enterprises.results.download', $certificate->slack) }}">Descargar</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
