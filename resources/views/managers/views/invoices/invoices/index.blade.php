...
@section('content')
    ...
    @include('accountings.includes.card', ['title' => 'Facturación'])
    ...
    <div class="widget-content searchable-container list">
                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ Request::fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('manager.invoices.report') }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Reporte">
        ...
        <div class="card card-body">
                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    @foreach ($invoices as $key =>$invoice)
                        <tr class="search-items">
                            ...
                            <td>
                                <span class="usr-ph-no" data-phone="{{ date('Y-m-d', strtotime($invoice->updated_at)) }}">{{ date('Y-m-d', strtotime($invoice->updated_at)) }}</span>
                            </td>
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.invoices.edit',$invoice->slack) }}">Editar</a>
                                        </li>


                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.invoices.view',$invoice->slack) }}">General</a>
                                        </li>

                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.invoices.details',$invoice->slack) }}">Detallado</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
            ...
            <div class="result-body ">
                <span>Mostrar {{ $invoices->firstItem() }}-{{ $invoices->lastItem() }} de {{ $invoices->total() }} resultados</span>
                <nav>
