...
@section('page_header')
    @include('managers.includes.card', ['title' => 'Editar empleado'])
@endsection
@section('content')
  ...
  <div class="row g-4 align-items-start">
    ...
    <div class="col-lg-8">
      ...
      <form id="formUsers" enctype="multipart/form-data" role="form"
            data-update-url="{{ route('manager.distributors.staffs.update') }}"
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p class="text-muted mb-0">Los empleados del distribuidor tienen acceso a su portal para gestionar las inscripciones y cursos de sus empresas asignadas.</p>
        </div>
      </div>
...
@push('scripts')
<script src="{{ asset('managers/js/views/distributors/staffs/edit.js') }}"></script>
@endpush
