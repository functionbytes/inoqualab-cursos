                ...
                <div class="col-md-12 col-xl-12">
                    <form class="position-relative form-search" action="{{ Request::fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('manager.distributors.staffs.create', $distributor->slack) }}" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Crear">
...
{{--                                        <li>--}}
{{--                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.distributors.staffs.history', $user->slack) }}">--}}
{{--                                                Historial--}}
{{--                                            </a>--}}
{{--                                        </li>--}}
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.distributors.staffs.view', $user->slack) }}">
                                                Visualizar
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.distributors.staffs.edit', $user->slack) }}">
                                                Editar
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('manager.distributors.staffs.destroy', $user->slack) }}">
                                                Eliminar
                                            </a>
                                        </li>
