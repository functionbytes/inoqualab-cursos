        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1 fw-bold">Distribuidores</h5>
                        <p class="mb-0 text-muted">Gestiona los distribuidores de la plataforma</p>
                    </div>
                    <div class="ms-auto">
                        @can('distributors.create')
                        <a href="{{ route('manager.distributors.create') }}" class="btn btn-primary">
                            Nuevo distribuidor
                        </a>
                        @endcan
                    </div>
            ...
            <div class="card-body">
                        ...
                        <table class="table table-hover align-middle text-nowrap mb-0">
                            ...
                            <tbody>
                                @foreach($distributors as $distributor)
                                    <tr>
                                        <td>
                                            <div class="fw-semibold">{{ Str::words($distributor->title, 12, '...') }}</div>
                                        </td>
                                        <td class="text-center">
                                            @if($distributor->available)
                                        ...
                                        <td class="text-center">
                                            <span class="text-muted">{{ date('d/m/Y', strtotime($distributor->updated_at)) }}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('manager.distributors.navegation', $distributor->slack) }}">
                                                            Dashboard
                                                        </a>
                                                    </li>
                                                    @can('distributors.update')
                                                    <li>
                                                        <a class="dropdown-item"
                                                           href="{{ route('manager.distributors.edit', $distributor->slack) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    @endcan
                                                    @can('distributors.delete')
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li>
                                                        <a class="dropdown-item btn-delete" href="#"
                                                           data-url="{{ route('manager.distributors.destroy', $distributor->slack) }}"
                                                           data-title="Eliminar: {{ $distributor->title }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                    @endcan
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        @if(($searchKey ?? '') || ($available ?? '') !== '')
                            <a href="{{ route('manager.distributors') }}" class="btn btn-outline-secondary">
                                Ver todos
                            </a>
                        @else
                            @can('distributors.create')
            ...
            @if($distributors->hasPages())
                <div class="card-footer bg-white border-top d-flex justify-content-between align-items-center">
                    <span class="text-muted">
                        Mostrando {{ $distributors->firstItem() }}–{{ $distributors->lastItem() }} de {{ $distributors->total() }} distribuidores
                    </span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    ...
                    <a href="{{ route('manager.distributors') }}" class="btn btn-secondary w-100">
                        Limpiar filtros
                    </a>
                </div>
            </div>
