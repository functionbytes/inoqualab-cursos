...
@section('page_header')
    @php ob_start(); @endphp
<a href="{{ route('enterprise.notifications.markasread') }}" class="btn btn-primary" id="btn-mark-all">
...
@push('css')
<link rel="stylesheet" href="{{ asset('enterprises/css/views/notifications/index.css') }}">
@endpush
