...
@section('page_header')
    @include('enterprises.includes.card', ['title' => 'Resultados'])
@endsection
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div class="card-body border-bottom">
                ...
                @endphp
                <form method="GET" action="{{ route('enterprise.users.results', request()->route('slack')) }}" id="searchForm">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('enterprise.users.results.view', $certificate->slack) }}">Visualizar</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="{{ route('enterprise.users.results.download', $certificate->slack) }}">Descargar</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
...
@push('scripts')
    <script src="{{ asset('enterprises/js/views/users/results/index.js') }}"></script>
@endpush
