...
@section('page_header')
    ...
    @if (count($certificates) > 1)
        <a href="{{ route('enterprise.users.certificate.broad', $user->slack) }}" class="btn btn-primary btn-icon" title="Descargar todos" aria-label="Descargar todos">
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div class="card-body border-bottom">
                ...
                @endphp
                <form method="GET" action="{{ route('enterprise.users.certificates', $user->slack) }}" id="searchForm">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('enterprise.users.certificate.course', $certificate->slack) }}">Descargar</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
...
@push('scripts')
    <script src="{{ asset('enterprises/js/views/users/certificates/index.js') }}"></script>
@endpush
