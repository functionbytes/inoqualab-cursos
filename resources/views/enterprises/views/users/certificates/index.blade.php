                    ...
                    <form class="position-relative form-search" action="{{ Request::fullUrl() }}" method="GET">
                        <div class="row justify-content-between g-2 ">
                            ...
                            @if (count($certificates) > 1)
                                <div class="col-auto">
                                    <a href=" {{ route('enterprise.users.certificate.broad', $user->slack) }}" class="btn btn-primary">
                                    </a>
                                </div>
                             @endif
                        </div>
                            ...
                            <td class="text-left">
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('enterprise.users.certificate.course', $certificate->slack) }}">Descargar</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
