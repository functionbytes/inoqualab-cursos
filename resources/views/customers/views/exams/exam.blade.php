    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center py-4">
                <p class="mb-0">¿Deseas finalizar y enviar el examen? No podrás cambiar tus respuestas.</p>
            </div>
            <div class="modal-footer justify-content-center border-0 pt-0">
                <button type="button" class="btn ar-secondary" data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="btn ar-primary" id="examConfirmAccept">Aceptar</button>
            </div>
        </div>
    </div>
</div>
...
<style>
    ...
    #examConfirmModal .ar-primary, #examConfirmModal .ar-secondary { width: auto; padding: 11px 22px; }
</style>
@endpush
