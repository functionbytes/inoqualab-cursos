                ...
                <div class="position-relative">
                    ...
                    <div class="card-body p-4 justify-content-center row">
                        <div class="col-md-10 col-sm-12 text-center">
                            ...
                            <h2 class="fs-9 fw-semibold mb-4">{{ Str::upper($course->title) }}</h2>
                        </div>
                    </div>
                                ...
                                <div id="question_block" class="question-block">
                                    ...
                                    @if ($topic->type == 0)
                                        <div class="question" id="question-div">
                                            <form action="{{ route('customers.exam.store', $topic->id) }}" method="POST"
                                                  id="question-form">
        ...
        @push('scripts')
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    // D1: confirmar el envío y evitar dobles envíos del examen
                    var examSubmitting = false;
                    $('#question-form').on('submit', function(e) {
                        if (examSubmitting) { e.preventDefault(); return; }
                        if (!confirm('¿Deseas finalizar y enviar el examen? No podrás cambiar tus respuestas.')) {
                            e.preventDefault();
                            return;
                        }
                        examSubmitting = true;
