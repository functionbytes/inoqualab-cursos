{{--
    ...
    ruta de dashboard propia de distributor.
    ...
    @section('page_header')
        @include('distributors.includes.card', ['title' => '...'])
    @endsection
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        @if(isset($breadcrumbs) && is_array($breadcrumbs))
                            ...
                            @endforeach
                        @else
                            <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="{{ route('distributor.dashboard') }}">Inicio</a></li>
