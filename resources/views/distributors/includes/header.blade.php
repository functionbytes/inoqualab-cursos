{{--
    ...
    supports/includes/header.blade.php, con las rutas propias de distributor.
--}}
                    ...
                    <div class="dropdown-menu dropdown-menu-end notif-panel-dd" aria-labelledby="dropNotif">
                        ...
                        <div class="notif-panel-body">
                            @forelse($recentNotifs as $notif)
                                <a href="{{ route('distributor.notifications') }}" class="notif-item unread">
                        ...
                        <div class="notif-panel-foot">
                            <a href="{{ route('distributor.notifications') }}" class="btn btn-primary">Ver todas las notificaciones</a>
                            @if($unreadCount > 0)
            ...
            <div class="dock-wrap" id="user-dock-wrap">
                ...
                <div class="dock" id="user-dock">
                    ...
                    <div class="dock-list">
                        ...
                        <a href="{{ route('distributor.notifications') }}" class="dock-item">
