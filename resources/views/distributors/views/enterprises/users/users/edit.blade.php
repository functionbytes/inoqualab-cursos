    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            ...
            <form id="formUsers" enctype="multipart/form-data" role="form" onSubmit="return false"
                  data-update-url="{{ route('distributor.enterprises.users.update') }}"
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">Solo los usuarios con estado <strong>activo</strong> pueden acceder al portal de la empresa.</p>
                </div>
            </div>
...
@push('scripts')
    <script src="{{ asset('distributors/js/enterprises/users/users/edit.js') }}"></script>
@endpush
