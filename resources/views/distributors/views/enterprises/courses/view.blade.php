                                ...
                                <div class="dropdown dropstart">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <li class="{{ $inscription->culminated == 1 ? '' : 'd-none'}}">
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('distributor.enterprises.users.certificate.user', $inscription->slack) }}">
                                                Certificado
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item  d-flex align-items-center gap-3" href="{{ route('distributor.enterprises.courses.details', $inscription->slack) }}">
                                                Detalle
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('distributor.enterprises.courses.progress', $inscription->slack) }}">
                                                Reporte
                                            </a>
                                        </li>
                                    </ul>
