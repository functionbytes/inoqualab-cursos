        ...
        <form id="formUsers" enctype="multipart/form-data" role="form" onSubmit="return false">
          ...
          <div class="card-body border-top">
            <div class="d-flex no-block align-items-center">
              <h5 class="mb-0">Editar teacher</h5>
            </div>
    ...
    $(document).ready(function() {
      ...
      $("#formUsers").validate({
        ...
        submitHandler: function(form) {
          ...
          $.ajax({
            url: "{{ route('distributor.enterprises.staffs.update') }}",
            headers: {
            ...
            success: function(response) {
                ...
                if(response.success == true){
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "{{ route('distributor.enterprises.staffs', ':slack') }}".replace(':slack', slack);
                    }, 2000);
