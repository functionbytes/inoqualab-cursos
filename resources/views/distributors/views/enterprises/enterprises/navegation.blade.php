            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center mt--20">
                    <div class="col-sm-6 col-lg-4">
                        <a class="card" href="{{ route('distributor.enterprises.users', $enterprise->slack) }}">
                    ...
                    @if($distributor->enterprise_generate)
                        <div class="col-sm-6 col-lg-4">
                            <a class="card" href="{{ route('distributor.enterprises.staffs', $enterprise->slack) }}">
                                <div class="card-body text-center">
                                    <span class="fw-bolder text-uppercase fs-2 d-block mb-7">Opción</span>
                                    <div class="my-4">
                    ...
                    @endif
                    <div class="col-sm-6 col-lg-4">
                        <a class="card" href="{{ route('distributor.enterprises.courses', $enterprise->slack) }}">
                            <div class="card-body text-center">
                                <span class="fw-bolder text-uppercase fs-2 d-block mb-7">Opción</span>
                                <div class="my-4">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card" href="{{ route('distributor.enterprises.users.income', $enterprise->slack) }}">
                            <div class="card-body text-center">
                                <span class="fw-bolder text-uppercase fs-2 d-block mb-7">Opción</span>
                                <div class="my-4">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card" href="{{ route('distributor.enterprises.inscriptions', $enterprise->slack) }}">
                            <div class="card-body text-center">
                                <span class="fw-bolder text-uppercase fs-2 d-block mb-7">Opción</span>
                                <div class="my-4">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <a class="card" href="{{ route('distributor.enterprises.reassign', $enterprise->slack) }}">
                            <div class="card-body text-center">
                                <span class="fw-bolder text-uppercase fs-2 d-block mb-7">Opción</span>
                                <div class="my-4">
                                    <i class="font-navegation fa-duotone fa-credit-card-front"></i>
