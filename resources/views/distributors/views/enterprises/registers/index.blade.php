...
@section('content')
    ...
    $(document).ready(function() {
        ...
        $('#identification').on('blur', function () {
            ...
            $.ajax({
                url: '{{ route("distributor.registers.users.check") }}',
                method: 'POST',
                data: {
        ...
        $("#formRegisters").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "{{ route('distributor.registers.store') }}",
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        if(response.success == true){
                            ...
                            var urlEnterprises =  "{{ route('distributor.enterprises.users', ':slack') }}".replace(':slack', enterprise);
                            var url =  "{{ route('distributor.enterprises.users', ':slack') }}".replace(':slack', enterprise);
