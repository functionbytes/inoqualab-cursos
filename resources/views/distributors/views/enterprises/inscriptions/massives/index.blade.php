    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".registration", function () {
                ...
                $.ajax({
                    url: '{{ route("distributor.inscriptions.massives.enroll") }}',
                    type: 'POST',
                    data: {
            ...
            $('#enterprise').on('change', function() {
                ...
                $.ajax({
                    url: '{{ route('distributor.inscriptions.massives.get.users') }}',
                    type: 'POST',
                    data: {
                ...
                $.ajax({
                    url: '{{ route('distributor.inscriptions.massives.get.courses') }}',
                    type: 'POST',
                    data: {
                        enterprise: enterpriseId
                    },
            ...
            $("#formInscriptions").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('distributor.inscriptions.massives.store') }}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        type: "POST",
