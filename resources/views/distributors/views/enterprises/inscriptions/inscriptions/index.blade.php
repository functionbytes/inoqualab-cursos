    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".registration").on("click", function() {
                ...
                $.ajax({
                    url: '{{ route('distributor.inscriptions.enroll') }}', // Ruta para el método en el controlador
                    type: 'POST',
                    data: {
            ...
            $('#enterprise').on('change', function() {
                ...
                $.ajax({
                    url: '{{ route('distributor.inscriptions.get.users') }}',
                    type: 'POST',
                    data: {
                ...
                $.ajax({
                    url: '{{ route('distributor.inscriptions.get.courses') }}',
                    type: 'POST',
                    data: {
                        enterprise: enterpriseId
                    },
            ...
            $("#formInscriptions").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('distributor.inscriptions.store') }}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        type: "POST",
