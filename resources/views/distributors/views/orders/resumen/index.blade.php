    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            <form id="formReport" enctype="multipart/form-data" role="form" onSubmit="return false"
                  data-generate-url="{{ route('distributor.orders.resumen.generate') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        ...
                        <p class="text-muted small mb-0">
                            Genera el resumen de tus órdenes filtrando por empresa
                            y rango de fechas.
                        </p>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">
                        El resumen se descarga con las órdenes filtradas por empresa y el
...
@push('scripts')
    ...
    <script src="{{ asset('distributors/js/orders/resumen/index.js') }}"></script>
@endpush
