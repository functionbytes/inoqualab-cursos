    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            <form id="formUsers" enctype="multipart/form-data" role="form" onSubmit="return false"
                  data-update-url="{{ route('distributor.settings.profile.update') }}"
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        ...
                        <p class="text-muted small mb-0">
                            Actualiza tus datos personales de acceso al portal de distribuidor: nombre, correo
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">
                        Tu correo electrónico es tu usuario de acceso al portal. Si lo cambias,
                        usa el nuevo correo la próxima vez que inicies sesión. Deja la contraseña
                        en blanco para conservar la actual.
                    </p>
                </div>
            </div>
        </div>
...
@push('scripts')
    <script src="{{ asset('distributors/js/settings/profile/setting.js') }}"></script>
@endpush
