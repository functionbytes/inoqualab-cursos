...
@section('page_header')
    @include('distributors.includes.card', ['title' => 'Reporte factura'])
@endsection
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        ...
                        <p class="text-muted small mb-0">
                            Genera el reporte de tu facturación filtrando por condición, tipo de factura
                            y rango de fechas.
                        </p>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">
                        El reporte se descarga con los filtros seleccionados: empresa, condición,
                        tipo de factura y el rango de fechas indicado.
                    </p>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{ asset('distributors/js/invoices/report/index.js') }}"></script>
@endpush
