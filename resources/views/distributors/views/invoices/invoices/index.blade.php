    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div class="card-body border-bottom">
                ...
                @endphp
                <form method="GET" action="{{ route('distributor.invoices') }}" id="searchForm">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('distributor.invoices.view', $invoice->slack) }}">General</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="{{ route('distributor.invoices.detail', $invoice->slack) }}">Detallado</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
...
@push('scripts')
    <script src="{{ asset('distributors/js/invoices/invoices/index.js') }}"></script>
@endpush
