...
@section('page_header')
    @php ob_start(); @endphp
<a href="{{ route('accounting.notifications.markasread') }}" class="btn btn-primary" id="btn-mark-all">
...
@push('css')
<link rel="stylesheet" href="{{ asset('accountings/css/views/notifications/index.css') }}">
@endpush
