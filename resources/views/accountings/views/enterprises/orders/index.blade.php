...
@section('page_header')
    ...
    @include('accountings.includes.card', [
        'title' => 'Órdenes - ' . $enterprise->title,
  ...
  <div class="widget-content searchable-container list">
    ...
    <div class="card">
      ...
      <div class="card-body border-bottom">
        ...
        @endphp
        <form method="GET" action="{{ route('accounting.enterprises.orders', $enterprise->slack) }}" id="searchForm">
            ...
            @foreach ($orders as $order)
              <tr>
                ...
                <td class="text-center">
                  <span class="badge bg-secondary-subtle text-secondary">{{ $order->method->title }}</span>
                </td>
                <td class="text-center">
...
@push('scripts')
    <script src="{{ asset('accountings/js/views/enterprises/orders/index.js') }}"></script>
@endpush
