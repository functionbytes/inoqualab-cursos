...
@section('page_header')
    @include('accountings.includes.card', ['title' => 'Empresas'])
@endsection
        ...
        <div class="table-responsive">
          <table class="table table-hover align-middle text-nowrap mb-0">
            ...
            @foreach ($enterprises as $enterprise)
              <tr>
                <td>
                  <div class="fw-semibold">{{ Str::words(Str::upper(Str::lower($enterprise->title)), 5, '...') }}</div>
                </td>
                ...
                <td class="text-center">
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <a class="dropdown-item" href="{{ route('accounting.enterprises.orders', $enterprise->slack) }}">Ordenes</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="{{ route('accounting.enterprises.view', $enterprise->slack) }}">Visualizar</a>
                      </li>
                    </ul>
                  </div>
                </td>
...
@push('scripts')
    <script src="{{ asset('accountings/js/views/distributors/enterprises/index.js') }}"></script>
@endpush
