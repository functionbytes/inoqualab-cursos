        ...
        <table class="table search-table align-middle text-nowrap">
          ...
          @foreach ($distributors as $key => $distributor)
            <tr class="search-items">
              ...
              <td>
                  <span class="badge {{ $distributor->available == 1 ? 'bg-success-subtle text-success' : 'bg-secondary-subtle text-secondary' }} rounded-3 py-2 fw-semibold fs-2 d-inline-flex align-items-center gap-1">
              ...
              <td class="text-left">
                <div class="dropdown dropstart">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton-{{ $loop->index }}">
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('accounting.distributors.invoices', $distributor->slack) }}">Facturas</a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('accounting.distributors.orders', $distributor->slack) }}">Ordenes</a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('accounting.distributors.enterprises', $distributor->slack) }}">Empresas</a>
                    </li>
                    <li>
                      <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('accounting.distributors.view', $distributor->slack) }}">Visualizar</a>
                    </li>
                  </ul>
                </div>
              </td>
