                                        ...
                                        <div class="billing-address-content">
                                                    ...
                                                    <div class="text-left mx-3">
                                                        <address>
                                                            ...
                                                            <p class="mt-0 mb-0 {{ $invoice->distributor->address !=null ? '' : 'd-none' }}">
                                                                <span>Dirección :</span>
                                                                <strong>{{Str::ucfirst($invoice->distributor->address)}}</strong>
                                                            </p>
                                                            <p class="mt-0 mb-0">
                                            ...
                                            <div class="container">
                                                ...
                                                @foreach($details as $enterprise => $courses)
                                                    <div class="row mb-4">
                                                        <h4 class="invoice-content-enterprise">{{ Str::upper($enterprise) }}</h4>
                                                                    ...
                                                                    <tr>
                                                                        <td class="border-bottom-0">
                                                                            <div class="d-flex align-items-center gap-3">
                                                                                <h6 class="fw-semibold fs-2 mb-0">{{ $item['course'] }}</h6>
                                                                            </div>
                                                                        </td>
                                                                        <td class="border-bottom-0">
                                                                            <div class="d-flex align-items-center gap-3">
