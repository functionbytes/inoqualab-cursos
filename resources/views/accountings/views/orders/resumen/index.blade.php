...
@section('page_header')
    @include('accountings.includes.card', ['title' => 'Resumen ordenes'])
@endsection
@section('content')
    ...
    <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-8">
            <form id="formReport" enctype="multipart/form-data" role="form"
                  data-get-enterprises-url="{{ route('accounting.orders.resumen.get.enterprises') }}"
                  data-generate-url="{{ route('accounting.orders.resumen.generate') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-bottom">
                        <h6 class="mb-1 fw-bold">Resumen ordenes</h6>
                        <p class="text-muted small mb-0">
                            Genera el resumen de órdenes filtrando por distribuidor, empresa, condición,
                            método de pago, tipo de factura y rango de fechas.
                        </p>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">El resumen se genera con las órdenes que coincidan con los filtros seleccionados.</p>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{ asset('accountings/js/views/orders/resumen/index.js') }}"></script>
@endpush
