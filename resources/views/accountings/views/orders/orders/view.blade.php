...
@section('content')
    ...
    @include('accountings.includes.card', ['title' => 'Detalle Ordenes '. $order->slack])
                                                    ...
                                                    <div class="text-left mx-3">
                                                        <address>
                                                            ...
                                                            <h6 class="mt-0 mb-0 fw-bold invoice-customer">
                                                                <span>Cliente :</span>
                                                                <strong>{{Str::upper(Str::lower(($order->user->firstname ?? 'N/D')))}} {{Str::upper(Str::lower(($order->user->lastname ?? '')))}}</strong>
                                                            </h6>
                                                            <h6 class="mt-0 mb-0 fw-bold invoice-customer">
