{{--
    ...
    ruta de dashboard propia de accounting.
    ...
    @section('page_header')
        @include('accountings.includes.card', ['title' => '...'])
    @endsection
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        @if(isset($breadcrumbs) && is_array($breadcrumbs))
                            ...
                            @endforeach
                        @else
                            <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="{{ route('accounting.dashboard') }}">Inicio</a></li>
