{{--
    ...
    supports/includes/header.blade.php, con las rutas propias de accounting.
--}}
        ...
        <div class="app-header-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notif-panel-dd" aria-labelledby="dropNotif">
                        ...
                        <div class="notif-panel-body">
                            @forelse($recentNotifs as $notif)
                                <a href="{{ route('accounting.notifications') }}" class="notif-item unread">
                        ...
                        <div class="notif-panel-foot">
                            <a href="{{ route('accounting.notifications') }}" class="btn btn-primary">Ver todas las notificaciones</a>
                            @if($unreadCount > 0)
            ...
            <div class="dock-wrap" id="user-dock-wrap">
                ...
                <div class="dock" id="user-dock">
                    ...
                    <div class="dock-list">
                        <a href="{{ route('accounting.profile') }}" class="dock-item">
                            <i class="fas fa-user"></i> Ver perfil
                        </a>
                        <a href="{{ route('accounting.profile') }}" class="dock-item">
                            <i class="fas fa-gear"></i> Configuración
                        </a>
                        <a href="{{ route('accounting.notifications') }}" class="dock-item">
