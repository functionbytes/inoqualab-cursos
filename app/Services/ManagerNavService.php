...
class ManagerNavService extends BaseNavService
{
    ...
    protected static function menu(): array
    {
        return [
            ...
            'miniItems' => [
                ['id' => 'dashboard', 'icon' => 'home', 'tooltip' => 'Dashboard', 'sidebar_id' => 'dashboard', 'url' => 'manager.dashboard', 'order' => 1],
                ['id' => 'courses', 'icon' => 'courses', 'tooltip' => 'Cursos', 'sidebar_id' => 'courses', 'order' => 2],
                ['id' => 'orders', 'icon' => 'wallet', 'tooltip' => 'Órdenes', 'sidebar_id' => 'orders', 'order' => 3],
                ['id' => 'mails', 'icon' => 'mail', 'tooltip' => 'Correos', 'sidebar_id' => 'mails', 'order' => 4],
                ['id' => 'newsletter', 'icon' => 'newsletter', 'tooltip' => 'Newsletter', 'sidebar_id' => 'newsletter', 'order' => 5],
                ['id' => 'reviews', 'icon' => 'reviews', 'tooltip' => 'Reseñas', 'sidebar_id' => 'reviews', 'order' => 6],
                ['id' => 'platform', 'icon' => 'platform', 'tooltip' => 'Plataforma', 'sidebar_id' => 'platform', 'order' => 7],
                ['id' => 'users', 'icon' => 'users', 'tooltip' => 'Usuarios', 'sidebar_id' => 'users', 'order' => 8],
                ['id' => 'help', 'icon' => 'help', 'tooltip' => 'Ayuda', 'sidebar_id' => 'help', 'order' => 9],
                ['id' => 'analytics', 'icon' => 'chart', 'tooltip' => 'Analytics y SEO', 'sidebar_id' => 'analytics', 'order' => 10],
                ['id' => 'settings', 'icon' => 'sliders', 'tooltip' => 'Configuración', 'sidebar_id' => 'settings', 'order' => 11],
            ],
            'sidebars' => [
                'courses' => [
                    'sections' => [[
