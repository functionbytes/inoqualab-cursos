...
class UpdateInvoicesSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'panel_documents_design' => ['nullable', 'in:original,a,b,c'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'panel_documents_design.in' => 'El diseño seleccionado no es válido.',
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            ...
            'panel_documents_design' => 'diseño de órdenes y facturas',
        ];
    }
}
