...
/**
 * Restringe qué usuarios puede gestionar un agente con privilegios administrativos.
 *
 * Un agente 'support'/'manager' NO debe poder crear, editar ni eliminar usuarios con
...
{
    /**
     * Roles que un agente tiene permitido gestionar.
     *
