...
namespace App\Http\Controllers\Distributors\Inscriptions;

use App\Events\Inscriptions\InscriptionCreated;
use App\Http\Controllers\Controller;
use App\Http\Requests\Distributors\Inscriptions\StoreInscriptionRequest;
...
class InscriptionsController extends Controller
{
    public function index()
    {
        ...
        return view('distributors.views.enterprises.inscriptions.inscriptions.index')->with([
