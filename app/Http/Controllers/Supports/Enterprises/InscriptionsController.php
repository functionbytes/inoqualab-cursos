...
class InscriptionsController extends Controller
{
    public function index($slack)
    {
        ...
        return view('supports.views.enterprises.enterprises.inscriptions.index')->with([
    ...
    public function enroll(Request $request)
    {
        ...
        abort_if($distributor === null, 422, 'La empresa no tiene un distribuidor asignado.');

        // Ownership: el usuario debe pertenecer a la empresa (evita matricular a
        ...
        $reportitem->staff_id = $support->id;
