$(function () {
    ...
    // ── Filters modal ────────────────────────────────────────────────────────
    function initSettingsInstructionsInstructionsTable() {
        FilterToolbar.init({
    ...
    initSettingsInstructionsInstructionsTable();

    AjaxTable.init({ onLoaded: initSettingsInstructionsInstructionsTable });
