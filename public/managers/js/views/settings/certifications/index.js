$(function () {
    ...
    // ── Filters modal ────────────────────────────────────────────────────────
    function initSettingsCertificationsTable() {
        FilterToolbar.init({
        fields: { filterAvailable: 'popover_Available' },
    });
        BulkActions.init({
        url: page.data('bulk-action-url'),
        entityLabel: 'certificado(s)',
    });
    }

    initSettingsCertificationsTable();

    AjaxTable.init({ onLoaded: initSettingsCertificationsTable });
