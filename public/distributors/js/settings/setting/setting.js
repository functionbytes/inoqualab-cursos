$(document).ready(function () {
    ...
    $form.validate({
        ...
        ignore: '.ignore',
        rules: {
            mail_notification: { required: false },
            inscription_notification: { required: false },
            invoice_notification: { required: false },
        },
        message: {
            mail_notification: { required: 'El parametro es necesario.' },
            inscription_notification: { required: 'El parametro es necesario.' },
            invoice_notification: { required: 'El parametro es necesario.' },
        },
