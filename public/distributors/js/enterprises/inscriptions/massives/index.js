$(document).ready(function () {
    ...
    $('#courses').select2({ minimumResultsForSearch: 0 });
    ...
    $('#error-modal').on('hidden.bs.modal', function () {
        // Retraso para garantizar que el modal se haya cerrado antes de abrir el siguiente
        setTimeout(function () {
            showNextError();
        }, 300);
    });
    ...
    $form.validate({
        ...
        messages: {
            ...
            users: { required: 'Es necesario una opción.' },
        },
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success == true) {
                        ...
                        errorQueue = response.errors.slice();
                        showNextError();
                    }
                }
            });
