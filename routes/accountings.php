...
Route::group(['prefix' => 'accounting', 'middleware' => ['auth', 'accounting']], function () {
    ...
    Route::group(['prefix' => 'enterprises'], function () {
        ...
        Route::post('/update', [EnterprisesController::class, 'update'])->name('accounting.enterprises.update');
        Route::get('/edit/{slack}', [EnterprisesController::class, 'edit'])->name('accounting.enterprises.edit');
    ...
    Route::group(['prefix' => 'distributors'], function () {
        ...
        Route::post('/update', [DistributorsController::class, 'update'])->name('accounting.distributors.update');
        Route::get('/edit/{slack}', [DistributorsController::class, 'edit'])->name('accounting.distributors.edit');
    ...
    Route::group(['prefix' => 'orders'], function () {
        ...
        Route::get('/get', [OrdersController::class, 'get'])->name('accounting.orders.get');
        Route::get('/create', [OrdersController::class, 'create'])->name('accounting.orders.create');
        Route::post('/store', [OrdersController::class, 'store'])->name('accounting.orders.store');
        ...
        Route::delete('/destroy/{slack}', [OrdersController::class, 'destroy'])->name('accounting.orders.destroy');
    ...
    Route::group(['prefix' => 'invoices'], function () {
        ...
        Route::get('/get', [InvoicesController::class, 'get'])->name('accounting.invoices.get');
        ...
        Route::delete('/destroy/{slack}', [InvoicesController::class, 'destroy'])->name('accounting.invoices.destroy');
