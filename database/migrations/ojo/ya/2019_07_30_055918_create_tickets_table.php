...
class CreateTicketsTable extends Migration
{
    public function up()
    {
        Schema::create('tickets', function (Blueprint $table) {
            ...
            $table->foreign('status_id')->references('id')->on('status_tickets')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('priority_id')->references('id')->on('priorities_tickets')->onDelete('cascade')->onUpdate('cascade');
            $table->foreign('category_id')->references('id')->on('categories_tickets')->onDelete('cascade')->onUpdate('cascade');
